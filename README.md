...
Compass is a repository used to store solutions to various issues encountered in development and daily use. This repository includes content on operating system installation, software configuration, development tool usage, and more, aimed at facilitating quick review and reuse of solutions.
...
- [WireGuard VPN Setup](./tools/WireGuard%20VPN%20Setup.md) - Detailed configurations on setting up a WireGuard VPN server and peer.
- [Resolve mDNS Addresses Inside a Container](./tools/Resolve%20mDNS%20Addresses%20Inside%20a%20Container.md) - A solution to start avahi-daemon inside containers.

## Performance Testing

Focuses on performance testing methods for various devices and systems.

- [Raspberry Pi Performance Testing](./benchmark/Raspberry%20Pi%20Performance%20Testing.md) - Comprehensive guide on assessing the performance of Raspberry Pi.
